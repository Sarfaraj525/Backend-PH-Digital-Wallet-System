...
const createUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isUserExist) {
        throw new AppError_1.default("User Already Exist", http_status_codes_1.default.BAD_REQUEST);
    }
...
const updateUser = (userId, payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (payload.role) {
        if (decodedToken.role === user_interface_1.Role.USER || decodedToken.role === user_interface_1.Role.AGENT) {
            throw new AppError_1.default("You are not authorized", http_status_codes_1.default.FORBIDDEN);
        }
